...
let matrix_range_f =
  L.declare_function "matrix_create_range" matrix_range_t blastoff_module
;;
...
let matrix_tostring_f =
  L.declare_function "matrix_tostring" matrix_tostring_t blastoff_module
;;
...
let matrix_insert_t =
  L.function_type
    matrix_t
    [| matrix_t; matrix_t; matrix_t; matrix_t; matrix_t; matrix_t |]
;;
...
let matrix_transpose_f =
  L.declare_function "matrix_transpose" matrix_transpose_t blastoff_module
;;
